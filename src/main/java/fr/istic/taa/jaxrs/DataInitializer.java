...
public class DataInitializer {
    ...
    private Utilisateur createUtilisateur() {
        ...
        util.setEmail("utilisateur@yopmail.com");
        // passw0rd
        util.setHashPassword("$2a$12$W2npC1gc9w.bbOmdLdMF.O6zXvYKuWphkoqYjWPjF2/3Jnyq.yCz6");
    ...
    private Administrateur createAdministrateur() {
        ...
        admin.setEmail("administrateur@yopmail.com");
        // passw0rd
        admin.setHashPassword("$2a$12$W2npC1gc9w.bbOmdLdMF.O6zXvYKuWphkoqYjWPjF2/3Jnyq.yCz6");
    ...
    private Organisateur createOrganisateur() {
        ...
        orga.setEmail("organisateur@yopmail.com");
        // passw0rd
